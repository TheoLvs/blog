    ...
    <Layout
      ...
      >
        <div className="container" >
          <h1 className="hero__subtitle" style={{color:"white",fontSize:"40px"}}>EMERGENCE.PUB</h1>
          <h1 className="hero__subtitle" style={{color:"white"}}>Experiments on Artificial Life & Simulations</h1>
